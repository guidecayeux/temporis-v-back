...
router.get('/objets', async (req, res, next) => {
...
router.post('/objet', jwt.checkToken, adminGuard.checkIsAdmin('db'), history.saveInHistory('Créer utilisateur', 'db'), async (req, res, next) => {
